...
Last updated: May 8, 2026 (S26 — Track 6 #5.1 ships: `srd_resolver.py` pure-function SRD monster resolver, inaugural Doctrine §1b validated-suggester. Hook wired to `npc_upsert was_new=True`; `_post_srd_suggestion` to `#dm-aside`. 32 tests. Bones queue EMPTY.)
